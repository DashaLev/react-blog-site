...
class PhotographyPostsItem extends Component {
    render() {
        ...
        return (
            <>
            { this.props.category === "PHOTOGRAPHY" &&
...
PhotographyPostsItem.propTypes = {
    title:PropTypes.string.isRequired,
    category:PropTypes.string.isRequired,
    author:PropTypes.string.isRequired,
}
PhotographyPostsItem.defaultProps = {
    image:"/images/no-image.png"
}



export default PhotographyPostsItem